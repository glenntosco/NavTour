        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewerFingerprint = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DemoSessions_Demos_DemoId",
                        column: x => x.DemoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leads_DemoSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionEvents_DemoSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "DemoSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClickTargetSelector = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NavigationAction = table.Column<int>(type: "int", nullable: false),
                    NavigationTarget = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Steps_Demos_DemoId",
                        column: x => x.DemoId,
                        principalTable: "Demos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Steps_Frames_FrameId",
                        column: x => x.FrameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Annotations_Steps_StepId",
                        column: x => x.StepId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Demos_TenantId_Slug",
                table: "Demos",
                columns: new[] { "TenantId", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DemoSessions_DemoId",
                table: "DemoSessions",
                column: "DemoId");

            migrationBuilder.CreateIndex(
                name: "IX_Frames_DemoId",
                table: "Frames",
                column: "DemoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Steps_DemoId",
                table: "Steps",
                column: "DemoId");

            migrationBuilder.CreateIndex(
                name: "IX_Steps_FrameId",
                table: "Steps",
                column: "FrameId");
